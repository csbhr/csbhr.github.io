...
# 圆圈中最后剩下的数字
[Leetcode Link](https://leetcode-cn.com/problems/yuan-quan-zhong-zui-hou-sheng-xia-de-shu-zi-lcof/)
...
在上面的模拟过程中，去除的第一个数的编号为 $m-1$ ，那剩下的 n-1 个数为 $[0, 1, ..., m-2, m, ..., n-1]$ ，那个在解下一个子问题 $F(n-1, m)$ 时，对这个 n-1 个数重新编号，即 $[n-m, n-m+1, ..., n-2, 0, ..., n-m-1]$ 。  
